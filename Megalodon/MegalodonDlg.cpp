...
// MegalodonDlg.cpp : implementation file
//

#include "pch.h"
#include "framework.h"
#include "Megalodon.h"
#include "MegalodonDlg.h"
...
CMegalodonDlg::CMegalodonDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MEGALODON_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMegalodonDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMegalodonDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMegalodonDlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// CMegalodonDlg message handlers

BOOL CMegalodonDlg::OnInitDialog()
{
...
void CMegalodonDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMegalodonDlg::OnQueryDragIcon()
{
